        ...
        {showInfo && 
          <div className="absolute top-0 right-3 text-xs text-left p-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-500 z-50 w-2/3">
            ...
            <p>
              ...
              в 2022–2023 гг. В 2024 году наблюдалось небольшое увеличение, однако
              показатель 2025 года пока неполный.
            </p>

            <p>Для детального анализа доступны вкладки:</p>

            <p>• «По месяцам года» — помесячная динамика внутри каждого года</p>
            <p>• «По месяцам (в среднем)» — средние месячные значения</p>
          </div>
        }
