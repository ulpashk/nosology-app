      ...
      <div className="flex-1 min-h-0 relative flex flex-col">
        {showInfo && 
          <div className="absolute top-0 right-3 text-xs text-left p-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-500 z-50 w-1/3">
            Диаграмма отражает распределение пациентов по диспансерному учёту. 
            «Алматинский онкологический центр» занимает около 50% всех пациентов, 
            что связано с высокой распространённостью онкологических заболеваний 
            и ролью центра как основного специализированного учреждения города.
          </div>
        }
