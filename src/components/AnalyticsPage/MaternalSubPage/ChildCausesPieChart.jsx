      ...
      <div className="flex-1 min-h-0 relative flex flex-col">
        {showInfo && 
          <div className="absolute top-0 right-3 text-xs text-left p-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-500 z-50 w-2/3">
            Диаграмма показывает распределение причин детской смертности, включая пневмонию, врождённые формы пневмонии, 
            БЛД и другие перинатальные и инфекционные состояния. 
            Эти категории отражают характерные для раннего возраста риски, 
            связанные с дыхательными нарушениями, инфекционными процессами и 
            внезапными критическими состояниями у новорождённых. 
          </div>
        }
