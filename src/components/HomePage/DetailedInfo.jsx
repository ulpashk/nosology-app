  ...
  const formatAvgPerson = (value) => {
    ...
    return (
        <div className="space-y-2 text-[11px] md:text-xs bg-white/95 p-2 md:p-3 border-t">
          ...
          <p className="text-gray-500 text-[10px] md:text-xs">{buildingData.type}</p>
          <p className="text-gray-500 text-[10px] md:text-xs">{buildingData.district} район, {buildingData.address} </p>
